...
- 🧠 **解释**：是用外部 LLM 对段落、和声走向、整体风格和可疑点进行自然语言解释。
...
和弦识别需要本地自动和弦识别运行时。本项目默认对接论文 **Enhancing Automatic Chord Recognition via Pseudo-Labeling and Knowledge Distillation** 对应的方法实现，请将模型目录设置为：
